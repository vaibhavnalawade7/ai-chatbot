...
class login_page:
    def __init__(self, root):
        self.window = root
        self.window.title("Log In Desktop Voice Assitantant")
        # Set the window size
        # Here 0,0 represents the starting point of the window 
        self.window.geometry("1280x800+0+0")
        self.window.config(bg = "white")

        # Connetcting Database
        ...
        if cursor.fetchone()[0]==0:
            cursor.execute("""create table user_register(
        ...
        label1 = Label(self.frame1, text= "Ai Desktop", font=("times new roman", 40, "bold"), bg="yellow", fg="red").place(x=100,y=300)
        label2 = Label(self.frame1, text= "Voice Assitant", font=("times new roman", 40, "bold"), bg="yellow", fg="RoyalBlue1").place(x=162,y=300)
        label3 = Label(self.frame1, text= "Personal Assitant", font=("times new roman", 13, "bold"), bg="yellow", fg="brown4").place(x=100,y=360)
        ...
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to the Desktop Voice Assitantant family",parent=self.window)
