...
def wishme():
    ...
    speak("Myself Aisha! How may I help you sir") 
...
def play():
    ...
    while True:
        ...
        city=get_location()
        if city=="Pune":
            var.set("You are in Pune")
            window.update()
        else:
            var.set(f"You are in {city}")
            window.update()
            speak(f"You are in {city}. Go to Pune first.")
            continue
        ...
        if 'exit' in query:
            ...
            var.set('Hello Everyone! My self Aisha')
            window.update()
            speak('Hello Everyone! My self Aisha')
            ...
            var.set("Myself Aisha Sir")
            window.update()
            speak('myself Aisha sir')
